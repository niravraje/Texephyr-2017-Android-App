...
public class FragmentSports extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDataset = getResources().getStringArray(R.array.SportsNames);
        mImageset = getResources().obtainTypedArray(R.array.SportsImages);
        mDescription = getResources().getStringArray(R.array.SportsDescriptions);
        mRules = getResources().getStringArray(R.array.SportsRules);
        mContacts = getResources().getStringArray(R.array.SportsContacts);
    }
