...
public class FragmentGaming extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDataset = getResources().getStringArray(R.array.GamingNames);
        mImageset = getResources().obtainTypedArray(R.array.GamingImages);
        mDescription = getResources().getStringArray(R.array.GamingDescriptions);
        mRules = getResources().getStringArray(R.array.GamingRules);
        mContacts = getResources().getStringArray(R.array.GamingContacts);
    }
